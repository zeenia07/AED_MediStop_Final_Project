...
public class CompleteDonationRelatedDetailsJPanel extends javax.swing.JPanel 
{
    ...
    private void initComponents() {
        ...
        add(lblTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 24, -1, 30));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 677, 264));
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 20, -1, -1));

        lblName.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        lblName.setForeground(new java.awt.Color(0, 51, 153));
        lblName.setText("Funding Organisation Name");
        add(lblName, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, 260, -1));

        lblValue.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        lblValue.setForeground(new java.awt.Color(0, 51, 153));
